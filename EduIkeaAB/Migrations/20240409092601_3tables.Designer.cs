...
namespace EduIkeaAB.Migrations
{
    ...
    [Migration("20240409092601_3tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduIkeaAB.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("EduIkeaAB.Models.DepartmentList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduIkeaAB.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("EduIkeaAB.Models.DepartmentList", b =>
                {
                    b.HasOne("EduIkeaAB.Models.Department", "Department")
                        .WithMany("DepartmentList")
                        .HasForeignKey("FkDepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduIkeaAB.Models.Employee", "Employee")
                        .WithMany("DepartmentList")
